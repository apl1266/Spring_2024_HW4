...
class Planner:
    ...
    @print_runtime
    def value_iteration(self, gamma=1.0, n_iters=1000, theta=1e-10, warning_on=False):
        """
        PARAMETERS:
        ...
        for k in range(n_iters):
            if pi_track[k]==pi:
                pi_con=k
                break
        return V, V_track, pi, pi_track, i, pi_con, t

    @print_runtime
    def policy_iteration(self, gamma=1.0, n_iters=50, theta=1e-10, seed=None, warning_on=False):
        """
        PARAMETERS:
